...
public class WifiUtils {
    private static WifiManager localWifiManager;//提供Wifi管理的各种主要API，主要包含wifi的扫描、建立连接、配置信息等
    private WifiInfo localWifiInfo;
    ...
    //检查WIFI状态
    public static int WifiCheckState(){
...
//	}
    ...
    public boolean WifiOpen()
    {
        ...
        if (!localWifiManager.isWifiEnabled())
        {
            bRet = localWifiManager.setWifiEnabled(true);
        }
        return bRet;
    }
...
//        mWifiList = mWifiManager.getScanResults();
        // 得到配置好的网络连接
//        mWifiConfiguration = localWifiManager.getConfiguredNetworks();
    }
